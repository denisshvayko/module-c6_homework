...
function change_icon(){
    if (resultNode.innerHTML === ico2){
        resultNode.innerHTML = ico1;
    }
    else{
        resultNode.innerHTML = ico2;
    }
}

const btnStart = document.querySelector('.js_button');
btnStart.addEventListener('click', change_icon);

// Работает
// let resultNode = document.querySelector('.svg-ico');
// let resultNode1 = document.querySelector('svg').getAttribute('class');
...
// function change_icon(){
//     console.log(resultNode1)
//     if (resultNode1 === "bi bi-arrow-down-left-circle"){
//         resultNode.innerHTML = ico2;
//     }
//     else{
//         resultNode.innerHTML = ico1;
//     }
//     resultNode1 = document.querySelector('svg').getAttribute('class');
//}
